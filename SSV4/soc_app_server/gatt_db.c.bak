...
{
0x49, 0xcd, 0x14, 0x92, 0xae, 0x3f, 0x3f, 0x8a, 0xc6, 0x41, 0xe2, 0x4d, 0xb3, 0xbb, 0xaa, 0xa4, 
0x69, 0xcc, 0x0d, 0x1b, 0x6b, 0xc0, 0x6d, 0xbc, 0x49, 0x43, 0x6f, 0x06, 0xc6, 0x0b, 0xec, 0x1c, 
...
0x81, 0xc2, 0x00, 0x2d, 0x31, 0xf4, 0xb0, 0xbf, 0x2b, 0x42, 0x49, 0x68, 0xc7, 0x25, 0x71, 0x41, 
0x30, 0xb5, 0x21, 0x04, 0x68, 0xa8, 0xf6, 0xa3, 0xc7, 0x44, 0x46, 0xe9, 0x89, 0x01, 0xb5, 0x93, 
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_29 ) = {
	.len=26,
	.data={0x74,0x68,0x69,0x73,0x20,0x69,0x73,0x20,0x6a,0x75,0x73,0x74,0x20,0x61,0x20,0x70,0x6c,0x61,0x63,0x65,0x68,0x6f,0x6c,0x64,0x65,0x72,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_27 ) = {
	.len=19,
	.data={0x02,0x1d,0x00,0x30,0xb5,0x21,0x04,0x68,0xa8,0xf6,0xa3,0xc7,0x44,0x46,0xe9,0x89,0x01,0xb5,0x93,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_26 ) = {
	.len=16,
	.data={0x81,0xc2,0x00,0x2d,0x31,0xf4,0xb0,0xbf,0x2b,0x42,0x49,0x68,0xc7,0x25,0x71,0x41,}
};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_14 ) = {
	.len=5,
	.data={0x02,0x10,0x00,0x01,0x2a,}
};
uint8_t bg_gattdb_data_attribute_field_13_data[40]={0x45,0x78,0x74,0x65,0x6e,0x64,0x65,0x64,0x20,0x41,0x64,0x76,0x65,0x72,0x74,0x69,0x73,0x69,0x6e,0x67,0x20,0x54,0x65,0x73,0x74,0x20,0x44,0x65,0x76,0x69,0x63,0x65,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_12 ) = {
	.len=5,
	.data={0x0a,0x0e,0x00,0x00,0x2a,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_11 ) = {
	.len=2,
	.data={0x00,0x18,}
};
uint8_t bg_gattdb_data_attribute_field_10_data[1]={0x00,};
...
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_9 ) = {
	.len=19,
	.data={0x02,0x0b,0x00,0x69,0xcc,0x0d,0x1b,0x6b,0xc0,0x6d,0xbc,0x49,0x43,0x6f,0x06,0xc6,0x0b,0xec,0x1c,}
};
GATT_DATA(const struct bg_gattdb_buffer_with_len	bg_gattdb_data_attribute_field_8 ) = {
	.len=16,
	.data={0x49,0xcd,0x14,0x92,0xae,0x3f,0x3f,0x8a,0xc6,0x41,0xe2,0x4d,0xb3,0xbb,0xaa,0xa4,}
};
...
GATT_DATA(const struct bg_gattdb_attribute bg_gattdb_data_attributes_map[])={
    ...
    {.uuid=0x0004,.permissions=0x803,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_13},
    {.uuid=0x0002,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_14},
    {.uuid=0x0005,.permissions=0x801,.caps=0xffff,.datatype=0x00,.constdata=&bg_gattdb_data_attribute_field_15},
    ...
    {.uuid=0x8005,.permissions=0x801,.caps=0xffff,.datatype=0x01,.dynamicdata=&bg_gattdb_data_attribute_field_28},
...
GATT_DATA(const uint8_t bg_gattdb_data_adv_uuid128_map[])={0x49, 0xcd, 0x14, 0x92, 0xae, 0x3f, 0x3f, 0x8a, 0xc6, 0x41, 0xe2, 0x4d, 0xb3, 0xbb, 0xaa, 0xa4, 0x81, 0xc2, 0x00, 0x2d, 0x31, 0xf4, 0xb0, 0xbf, 0x2b, 0x42, 0x49, 0x68, 0xc7, 0x25, 0x71, 0x41, };
