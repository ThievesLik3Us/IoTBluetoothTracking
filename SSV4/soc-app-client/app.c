...
void appMain(gecko_configuration_t *pconfig)
{
  ...
  while (1) {
    ...
    // This section is for periodic advertisements Comment out next section (2M PHY) to use this section
...
//        break;
      ...
      case gecko_evt_gatt_server_user_write_request_id:
        ...
        // This section is for 2M PHY, comment out the next section to use this section
...
//		  break;
		  ...
		  // This section is for Periodic advertising comment out above section to use this section
		  case gecko_evt_le_gap_extended_scan_response_id:
		     {
